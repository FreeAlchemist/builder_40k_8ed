...
function detachmentsList () {
	...
	for (var i =0; i < rolesarr.length; i++){
		...
		var unitrole = rolesarr[i]
		// console.log(unitrole)
		var unitroleinfo = library[army].units[unitrole]
		if (unitroleinfo){
			console.log('UNITROLE: '+unitrole)
			console.log(unitroleinfo)
			var unitrolelength = unitroleinfo.length
			console.log('UNITROLELENGTH: '+unitrolelength)
				for (var m =0; m < unitroleinfo.length; m++) {
					var currentunitroleinfo = unitroleinfo[m]
					console.log(currentunitroleinfo)
					var currentunitrolelib= library[army].units[unitrole]
					var source = 'js/library/'+army+'/units/'+unitrole+'/'+currentunitrolelib[m]+'.js'
					console.log(source)
					Print(source)
				}
			}
	...
	// if(library[army].units.hq){
	// 	var hqlength = library[army].units.hq.length
	// 	console.log('hq: '+library[army].units.hq)
	// 	console.log('hq length: '+hqlength)
	// 	for (var i =0; i < hqlength; i++){
	// 		console.log(library[army].units.hq[i]+'.js')
	// 		// src="js/library_40k_separated.js"
	// 		var source = 'js/library/'+army+'/units/hq/'+library[army].units.hq[i]+'.js'
	// 		console.log(source)
	// 	}
	// }

	// if(library[army].units.elites){}
...
// var addunit = $('<script />')
// addunit.attr('type','text/javascript')
// addunit.attr('src','js/library/tyranids/units/hq/broodlord.js')
// addunit.appendTo($('body'))
// Print(broodlord)
import('/js/library/tyranids/units/hq/broodlord.js')
  .then(module => {
